...
export function ServiceFeeModal({ open, propertyId, propertyName, onClose }) {
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                          <div>
                            <Typography variant="small" className="text-gray-500 dark:text-gray-400">Qiymət:</Typography>
                            <Typography variant="small" className="text-gray-900 dark:text-white font-semibold">{serviceFee.price} AZN</Typography>
                          </div>
                          <div>
                            <Typography variant="small" className="text-gray-500 dark:text-gray-400">Tip:</Typography>
                          ...
                          <div>
                            <Typography variant="small" className="text-gray-500 dark:text-gray-400">Başlanğıc:</Typography>
                            <Typography variant="small" className="text-gray-900 dark:text-white">{serviceFee.start_date || "—"}</Typography>
                          </div>
                          <div>
                            <Typography variant="small" className="text-gray-500 dark:text-gray-400">Növbəti:</Typography>
                            <Typography variant="small" className="text-gray-900 dark:text-white">{serviceFee.next_date || "—"}</Typography>
                          </div>
                        </div>
                        <div className="mt-2">
                          <span
                      ...
                      <div className="flex gap-2 ml-4">
                        <Button variant="text" size="sm" onClick={() => handleEdit(serviceFee)} className="text-blue-600 dark:text-blue-400">
                          <PencilIcon className="h-4 w-4" />
                        </Button>
                        <Button variant="text" size="sm" onClick={() => handleDelete(serviceFee)} className="text-red-600 dark:text-red-400">
