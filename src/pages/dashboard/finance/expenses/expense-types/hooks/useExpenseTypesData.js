...
export function useExpenseTypesData(page, refreshKey = 0, sortConfig = { key: null, direction: "asc" }) {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const result = await fetchExpenseTypes(1, 10000);
