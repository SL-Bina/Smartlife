...
export function DebtorApartmentsSummaryCard({ totalDebt }) {
  ...
  return (
    <div className="flex justify-end mb-4">
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl shadow-lg border border-white/20 dark:border-gray-700/50 p-4 flex items-center gap-4 min-w-[220px]">
        ...
        <div>
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-0.5">{t("debtorApartments.summary.totalDebt")}</p>
