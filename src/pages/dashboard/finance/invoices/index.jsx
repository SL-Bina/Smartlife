...
import { createInvoice, updateInvoice, deleteInvoice } from "./api";
...
import { InvoicesFilterModal } from "./components/modals/InvoicesFilterModal";
import { InvoicesFormModal } from "./components/modals/InvoicesFormModal";
import { InvoicesViewModal } from "./components/modals/InvoicesViewModal";
import { InvoicesDeleteModal } from "./components/modals/InvoicesDeleteModal";
  ...
  return (
    <div className="">
      ...
      <Card className="border border-red-600 dark:border-gray-700 shadow-sm dark:bg-gray-800">
        ...
        >
          <InvoicesActions onFilterClick={() => setFilterOpen(true)} onCreateClick={openCreateModal} />
        </CardHeader>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              <Typography variant="small" className="text-red-600 dark:text-red-400">
                {t("invoices.error.loading")}: {error}
              </Typography>
            </div>
          ) : (
            <>
