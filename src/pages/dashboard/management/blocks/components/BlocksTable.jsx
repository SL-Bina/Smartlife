...
export function BlocksTable({ blocks, onView, onEdit, onDelete }) {
        ...
        <thead>
          <tr>
            {[
              ...
              t("blocks.table.building"),
              t("blocks.table.floorsCount"),
              t("blocks.table.apartmentsCount"),
              t("blocks.table.actions"),
            ].map((el, idx) => (
              <th
                key={el}
