...
export function PropertiesFilterModal({ open, onClose, filters, onFilterChange, onApply, onClear }) {
  ...
  const hasActiveFilters = 
    ...
    (filters.number && filters.number.trim() !== "") ||
    (filters.block && filters.block.trim() !== "") ||
      ...
      <DialogBody divider className="space-y-4 dark:bg-gray-800 py-6 max-h-[70vh] overflow-y-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              placeholder="Mənzil nömrəsi yaz..."
