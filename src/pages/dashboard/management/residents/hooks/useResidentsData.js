...
export function useResidentsData(filters, page, refreshKey = 0, sortConfig = { key: null, direction: "asc" }) {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const result = await fetchResidents(filters, 1, 10000);
