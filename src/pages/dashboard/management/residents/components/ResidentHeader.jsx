...
export function ResidentHeader() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl shadow-lg p-3 sm:p-4 md:p-5 lg:p-6 bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 mt-4 sm:mt-3 md:mt-4">
