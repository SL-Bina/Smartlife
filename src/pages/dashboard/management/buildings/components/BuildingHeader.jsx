...
export function BuildingHeader() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl shadow-lg p-6 bg-gradient-to-r from-purple-600 to-purple-800 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 border border-gray-200 dark:border-gray-700 mt-4">
