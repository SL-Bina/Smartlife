...
export function BuildingSearchModal({ open, onClose, onSearch, currentSearch = {} }) {
  ...
  const getRgbaColor = (hex, opacity = 1) => {
    if (!hex) return `rgba(147, 51, 234, ${opacity})`;
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <CustomInput
                ...
                placeholder="Bina adına görə axtarış"
