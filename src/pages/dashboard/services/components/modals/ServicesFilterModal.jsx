...
export function ServicesFilterModal({ open, onClose, filters, onFilterChange, onApply, onClear }) {
      ...
      <DialogBody divider className="space-y-4 dark:bg-gray-800 dark:border-gray-700 py-6">
        <div>
          <Typography variant="small" color="blue-gray" className="mb-2 font-medium dark:text-gray-300">
            {t("services.filter.name")}
          </Typography>
          <Input
            label={t("services.filter.enterName")}
            value={filters.name || ""}
