...
const PropertyServiceFeePage = () => {
  ...
  const handleSave = async () => {
    if (!feeValue || parseFloat(feeValue) <= 0) {
      alert("Servis haqqı düzgün daxil edilməlidir");
      return;
    }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border border-red-500 shadow-sm">
            <CardHeader
              ...
              shadow={false}
              color="transparent"
              className="m-0 p-6 border-b border-blue-gray-100"
            >
              ...
              <div className="max-w-md">
                <div className="mb-6">
                  ...
                  <Typography variant="small" className="text-blue-gray-400">
                    Cari servis haqqı: <span className="font-semibold text-blue-gray-700">{apartment?.serviceFee} AZN</span>
                  </Typography>
                </div>
                ...
                <div className="space-y-4">
                  {feeHistory.map((item, index) => (
                    <div
                      key={item.id}
                      className={`pb-4 ${
                        index !== feeHistory.length - 1 ? "border-b border-blue-gray-100" : ""
                      }`}
                    >
                      ...
                      <Typography variant="small" className="text-blue-gray-400 text-xs mt-1">
                        Dəyişdirən: {item.changedBy}
                      </Typography>
                    </div>
                  ))}
                </div>
